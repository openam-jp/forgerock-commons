...
public class AuthModuleTwo implements AsyncServerAuthModule {
    ...
    public Promise<AuthStatus, AuthenticationException> validateRequest(MessageInfoContext messageInfo,
        ...
        return Promises.newExceptionPromise(new AuthenticationException(AUTH_MODULE_TWO_VALIDATE_REQUEST_HEADER_NAME
    ...
    public Promise<AuthStatus, AuthenticationException> secureResponse(MessageInfoContext messageInfo,
        ...
        Request request = messageInfo.getRequest();
        String header = request.getHeaders().getFirst(AUTH_MODULE_TWO_SECURE_RESPONSE_HEADER_NAME.toLowerCase());
        ...
        return Promises.newExceptionPromise(new AuthenticationException(AUTH_MODULE_TWO_SECURE_RESPONSE_HEADER_NAME
                + " header not set, so throwing AuthException."));
    }
