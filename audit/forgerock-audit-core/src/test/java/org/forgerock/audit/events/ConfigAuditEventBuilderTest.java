...
public class ConfigAuditEventBuilderTest {

    /**
     * Example builder of audit activity events for some imaginary product "OpenProduct".
     */
    static class OpenProductConfigAuditEventBuilder<T extends OpenProductConfigAuditEventBuilder<T>>
            extends ConfigAuditEventBuilder<T> {

        @SuppressWarnings("rawtypes")
        public static OpenProductConfigAuditEventBuilder<?> productConfigEvent() {
